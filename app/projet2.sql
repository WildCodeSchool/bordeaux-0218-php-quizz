...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 30 avr. 2018 à 18:43
...
(2, 'quizz de Amine', 'Arcachon', 2),
(3, 'quizz de Marie', 'Arcachon', 6),
(4, 'quizz de David', 'Culture Générale', 3),
...
(87, 'Ordonez', 'Alexis', 'Arcachon', 'alexis.ordo@wcs.fr', 'AZERTY', 'user'),
...
(91, 'Philipe', 'Morris', 'Paris', 'phi@wcs.fr', 'Pjyr', 'user'),
(92, 'Marie', 'Reciv', 'Limoges', 'marir@wcs.fr', 'Grt', 'user'),
(93, 'Patrick', 'Bruel', 'Paris', 'patrickb@wcs.fr', 'Azer', 'user'),
(94, 'Descombes ', 'Gabriel', 'Bordeaux', 'gabby@wcs.fr', 'Azert', 'user'),
(95, 'Aurelien', 'Barbier', 'Bordeaux', 'aurelb@g.fr', 'Azert', 'user'),
(111, 'Portman', 'Nathalie', 'Le Teich', 'nathalie.portman@wcs.fr', 'leonisgreat', 'user'),
(112, 'Shaqur', '2pac', 'Los Angeles', '2pac@wcs.fr', 'californialove', 'user'),
(113, 'Maxime', 'Ordonez', 'Bayonne', 'maxordonez@gmail.com', 'llllllll', 'user'),
(114, 'Maxime', 'Ordonez', 'Bayonne', 'maxordonez@gmail.com', 'llllllll', 'user');
